<template>
  <div class='content rules'>
    <img class="center" alt='Wump Header' src='../assets/WumpHeader.png' />
...
<ol> 
    ...
    <li>Don't Steal: Don't repost/use creative material without explicit written permission from the creator.</li>
</ol>
